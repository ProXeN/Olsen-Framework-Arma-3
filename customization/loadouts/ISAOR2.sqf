...
SET_GROUP(uniform) //Uniforme Básico
	["CUP_U_CRYE_G3C_AOR2"] call FNC_AddItem;
END_GROUP;

SET_GROUP(helmet) //Cascos
	["Maritime_Cover_AMP2", "Maritime_Cover_AMP8", "Maritime_Cover_AMP14", "Maritime_Cover_AMP20", "Maritime_Cover_AMP26", "Maritime_Cover_AMP146",
	 "Maritime_Cover_AMP1463", "Maritime_Cover_AMP14632", "Maritime_Cover_AMP146532", "Maritime_Cover_AMP146532_manta", "Maritime_Cover_AMP14632_manta"
	 ] call FNC_AddItemRandom;
END_GROUP;

SET_GROUP(uniformFTL) //Uniforme Lideres de Equipo
	["Crye_JPC1_AOR2"] call FNC_AddItem;
	["airframe_cover_2_ComtacIII", "airframe_cover_6_ComtacIII", "airframe_cover_10_ComtacIII", "airframe_cover_14_ComtacIII",
	 "airframe_cover_18_ComtacIII", "airframe_cover_22_ComtacIII", "airframe_cover_26_ComtacIII", "airframe_cover_2_ComtacIII_Arc",
	 "airframe_cover_6_ComtacIII_Arc", "airframe_cover_10_ComtacIII_Arc", "airframe_cover_14_ComtacIII_Arc", "airframe_cover_18_ComtacIII_Arc",
	 "airframe_cover_22_ComtacIII_Arc", "airframe_cover_26_ComtacIII_Arc"] call FNC_AddItemRandom;
	["is_invisible_backpack"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformM) //Uniforme Marksman
	["tfa_v_jpc_marksman_belt_rngrn", "tfa_v_mmac_marksman_belt_rngrn"] call FNC_AddItemRandom;
	["tfa_bp_hydration_rngrn"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformAR) //Uniforme Automatic Rifleman
	["tfa_v_jpc_hgunner_belt_rngrn", "tfa_v_mmac_hgunner_belt_rngrn"] call FNC_AddItemRandom;
	["tfa_bp_hydration_rngrn"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformAT) //Uniforme Rifleman AT
	["tfa_v_jpc_assaulter_belt_rngrn", "tfa_v_mmac_assaulter_belt_rngrn"] call FNC_AddItemRandom;
	["tfa_bp_Breacher_rngrn"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformENG) //Uniforme Engineer
	["tfa_v_jpc_assaulter_belt_rngrn", "tfa_v_mmac_assaulter_belt_rngrn"] call FNC_AddItemRandom;
	["tfa_bp_Pointman_rngrn"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformMEDIC) //Uniforme Medic
	["tfa_v_jpc_medic_belt_rngrn", "tfa_v_mmac_medic_belt_rngrn"] call FNC_AddItemRandom;
...
SET_GROUP(uniformCM) //Uniforme CM
	["tfa_v_jpc_teamleader_rngrn"] call FNC_AddItem;
