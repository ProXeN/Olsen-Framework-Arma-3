...
SET_GROUP(helmet) //Cascos
	["IS_Mich2000_Multicam", "IS_Mich2000_OGA", "IS_Mich2000_CamoSprayTAN",
	 "IS_Mich2000_2_Multicam", "IS_Mich2000_2_OGA", "IS_Mich2000_2_CamoSprayTAN",
	 "IS_OPS_Multicam", "IS_oga_OPS", "IS_Tan_spray_OPS", "USP_OPSCORE_FASTMTC_CMSW", 
	 "IS_OPS_2_multicam", "IS_oga_OPS_2", "IS_tan_spray_OPS_2", "milgp_h_opscore_01_KHK",
...
SET_GROUP(uniformFTL) //Uniforme Lideres de Equipo
	...
	"IS_AirFrame" ] call FNC_AddItemRandom;
	["tfw_ilbe_dd_coy"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformM) //Uniforme Marksman
	["IS_JPC_2", "IS_JPC_3"] call FNC_AddItemRandom;
	["IS_MC_Backpack_compact"] call FNC_AddItem;
END_GROUP;

SET_GROUP(uniformAR) //Uniforme Automatic Rifleman
	["IS_FAPC_MG_Multicam", "IS_CarrierRig_Gunner_Multicam", "IS_LBT6094_MG_Multicam", "IS_RAV_MG_Multicam",
	 "IS_FAPC_MG_OGA", "IS_CarrierRig_Gunner_OGA", "IS_LBT6094_MG_OGA", "IS_RAV_MG_OGA"] call FNC_AddItemRandom;
	["IS_MC_Backpack_compact"] call FNC_AddItem;
END_GROUP;
