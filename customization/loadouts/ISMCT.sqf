...
SET_GROUP(uniform) //Uniforme Básico
	["ARD_MCTropic_Camo_Cyre",
	 "ARD_MCTropic_Camo_Cyre_SS",
	 "ARD_MCTropic_Camo_Cyre_TS"
	] call FNC_AddItemRandom;
END_GROUP;

SET_GROUP(helmet) //Cascos
	["Maritime_AMP2", "Maritime_AMP8", "Maritime_AMP14", "Maritime_AMP20", "Maritime_AMP26", "Maritime_AMP32",
	 "Maritime_AMP146", "Maritime_AMP1463", "Maritime_AMP14632", "Maritime_AMP146532", "Maritime_AMP14632_manta", "Maritime_AMP146532_manta"
	 ] call FNC_AddItemRandom;
END_GROUP;

SET_GROUP(uniformFTL) //Uniforme Lideres de Equipo
	["tfa_v_mmac_teamleader_belt_rngrn", "tfa_v_jpc_teamleader_belt_rngrn"] call FNC_AddItemRandom;
	["airframe2_ComtacIII_Arc", "airframe6_ComtacIII_Arc", "airframe10_ComtacIII_Arc", "airframe14_ComtacIII_Arc", "airframe18_ComtacIII_Arc",
	"airframe22_ComtacIII_Arc", "airframe26_ComtacIII_Arc"] call FNC_AddItemRandom;
