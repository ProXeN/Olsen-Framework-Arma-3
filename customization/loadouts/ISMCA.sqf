...
SET_GROUP(uniform) //Uniforme Básico
	["ARD_MCArid_Camo_Cyre",
	 "ARD_MCArid_Camo_Cyre_SS",
	 "ARD_MCArid_Camo_Cyre_TS"
	] call FNC_AddItemRandom;
END_GROUP;

SET_GROUP(helmet) //Cascos
	["Maritime_AMP6", "Maritime_AMP12", "Maritime_AMP18", "Maritime_AMP24", "Maritime_AMP30", "Maritime_AMP36",
	 "Maritime_AMP182", "Maritime_AMP1832", "Maritime_AMP18322", "Maritime_AMP184322", "Maritime_AMP18322_manta", "Maritime_AMP184322_manta"
	 ] call FNC_AddItemRandom;
END_GROUP;

SET_GROUP(uniformFTL) //Uniforme Lideres de Equipo
	["Crye_JPC1_CB"] call FNC_AddItem;
	["airframe3_ComtacIII", "airframe7_ComtacIII", "airframe11_ComtacIII", "airframe15_ComtacIII", "airframe19_ComtacIII", "airframe23_ComtacIII",
	 "airframe27_ComtacIII", "airframe3_ComtacIII_Arc", "airframe7_ComtacIII_Arc", "airframe11_ComtacIII_Arc", "airframe15_ComtacIII_Arc", 
	 "airframe19_ComtacIII_Arc", "airframe23_ComtacIII_Arc", "airframe27_ComtacIII_Arc"] call FNC_AddItemRandom;
