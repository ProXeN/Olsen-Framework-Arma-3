...
{},                       /* 6: codeStart */
{},                       /* 7: codeTick */
{[(_this select 0),(_this select 2)] remoteExec ["bis_fnc_holdActionRemove",[0,-2] select isDedicated,true]; _target remoteExec ["CTS_Conversacion",[0,-2] select isDedicated]},    /* 8: codeCompleted */
{},                        /* 9: codeInterrupted */
[],                        /* 10: Arguments */
1,                        /* 11: Duration */
10,                        /* 12: priority */
