...
{},                       /* 6: codeStart */
{},                       /* 7: codeTick */
{[(_this select 0),(_this select 2)] remoteExec ["bis_fnc_holdActionRemove",[0,-2] select isDedicated,true]; titleCut ["", "White In",0.2]; playSound "OMCameraPhoto"; (_this select 0) setVariable ["var_foto", true, true]},    /* 8: codeCompleted */
{},                        /* 9: codeInterrupted */
[],                        /* 10: Arguments */
1,                        /* 11: Duration */
10,                        /* 12: priority */
