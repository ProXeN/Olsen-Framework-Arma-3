/*
  ...
  [[line1, line2], "SIDE", 0.15] execVM "fn_simpleConv.sqf";
*/
...
private _fnc_showSubtitles =
{
  ...
  //Show subtitle
  private _text = parseText format ["<t align = 'center' shadow = '2' font='RobotoCondensedBold' size = '0.52'><t color = '%1'>" + _from + ":</t><br/><t color = '#d0d0d0'>" + _text + "</t></t>", _colourHTML];
...
//Loop through all given lines
{
  ...
  private _handle = [_nameSpeaker, _text, _colourHTML, _break] spawn _fnc_showSubtitles;
