...
if (hasInterface) then {
  ...
  SHK_Fastrope_Helis = [
    ...
    // CTS	
    ["B_HH60A_gray_doors_F",["cargo_door_r"],[[1.23,2.24,-0.08],[-1.23,2,-0.08]]],
    ["B_MH60L_noprobe_F",["rope1hide","rope2hide"],[[1.23,2.24,-0.08],[-1.23,2,-0.08]]],
  ...
  SHK_Fastrope_fnc_createRopes = {
    ...
    {  
        ...
        // Open doors
      if (typeOf _heli == "B_MH60L_noprobe_F") then {
      {
        _heli animateSource [_x,1];
      } forEach (_x select 1);
      } else {
      {
